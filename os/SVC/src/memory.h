...
extern void* k_request_kernel_memory_block(void);
#define request_kernel_memory_block() _request_kernel_memory_block((U32)k_request_kernel_memory_block)
extern void* _request_kernel_memory_block(U32 p_func) __SVC_0;
//void* request_kernel_memory_block(void) __svc_indirect(0);
